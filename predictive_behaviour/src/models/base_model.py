...
class BaseModel(object):
    ...
    def init_parameters(self):
        ...
        with tf.name_scope('weights'):
            self.W1=tf.get_variable('W1', shape=[42,n2], dtype=tf.float32, initializer=self.weight_initializer)
        ...
        with tf.name_scope('biases'):
            self.b1=tf.get_variable('bias1', shape=[n2], initializer=self.bias_initializer)
            self.b2=tf.get_variable('bias2', shape=[n3], initializer=self.bias_initializer)
